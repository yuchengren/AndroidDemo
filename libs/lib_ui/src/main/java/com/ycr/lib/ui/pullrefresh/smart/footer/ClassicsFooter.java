package com.ycr.lib.ui.pullrefresh.smart.footer;
...
public class ClassicsFooter extends InternalClassics<com.scwang.smartrefresh.layout.footer.ClassicsFooter> implements RefreshFooter {
    ...
    public static CharSequence REFRESH_FOOTER_NOTHING = null;//"没有更多数据了";
    ...
    protected CharSequence mTextNothing;//"没有更多数据了";
