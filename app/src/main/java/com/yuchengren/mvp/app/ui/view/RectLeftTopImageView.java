...
public class RectLeftTopImageView extends ImageView {
    ...
    public RectLeftTopImageView(Context context) {
        super(context);

        init();
    }

    public RectLeftTopImageView(Context context, AttributeSet attrs) {
