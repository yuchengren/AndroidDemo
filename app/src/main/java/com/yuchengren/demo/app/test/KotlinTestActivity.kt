...
class KotlinTestActivity: BaseActivity() {
    ...
    override fun afterBindView(rootView: View?, savedInstanceState: Bundle?) {
        ...
        ImageHelper.display(imageView,Environment.getExternalStorageDirectory().path + "/test.png", ImageDisplayOption.build().imageDisplayType(ImageDisplayType.CIRCLE_CROP))
